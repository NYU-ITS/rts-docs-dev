...
The DLP scan is triggered by the Egress_2 script as part of the [data egress process](03_data_transfers.mdx). Once it is generated, you can explore the table of flagged items in BigQuery. First, open a query tab as shown in the screenshot below, and then use SQL queries like the examples in this guide to check specific items and view overall statistics on the table.
